...
func (d *Drsm) GetNewChunk() (*chunk, error) {
	...
	c := &chunk{Id: cn}
	c.AllocIds = make(map[int64]bool)
	var i int64
	for i = 0; i < 1000; i++ {
...
func (c *chunk) AllocateIntID() int64 {
	if len(c.FreeIds) == 0 {
...
func (c *chunk) ReleaseIntID(id int64) {
	var i int64
	i = id & 0x3ff
...
func getChunIdFromDocId(id string) int64 {
